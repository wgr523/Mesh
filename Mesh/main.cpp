...
int main()
{
    ...
    char path[100]="/Users/mac/Downloads/Tsinghua/高等计算机图形学/Mesh_helper/test_data/";// your path here
    float bili=0.05; // ratio
...
//        }
        if (!tmp.MergeOnePair()) {cout<<"(Cannot merge anymore. Terminated.)\n";break;}
    }
//
